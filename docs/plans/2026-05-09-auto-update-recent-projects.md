...
**Architecture:** 使用一个无依赖 Node.js 脚本处理 GitHub API、LLM 调用和 README marker 替换。脚本按 `pushed_at` 选择最近公开非 fork、非 archived 仓库。使用 GitHub Actions 定时执行脚本，并在 README 变更时自动提交。
